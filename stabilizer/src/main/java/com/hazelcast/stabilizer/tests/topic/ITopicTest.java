...
//
//    @Override
//    public void stopTest(long timeoutMs) throws Exception {
//        //todo: we should calculate remining timeout
//        super.stopTest(timeoutMs);
//
...
//            }
//
//            boolean stopped = (!waitForMessagesToComplete && testContext.stopped()) || l < 0;
//
//            if (stopped) {
