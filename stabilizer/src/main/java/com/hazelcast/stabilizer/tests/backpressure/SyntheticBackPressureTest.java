...
import com.hazelcast.stabilizer.tests.concurrent.atomiclong.AtomicLongTest;
    ...
    private class Worker implements Runnable, ExecutionCallback {
        ...
        public void run() {
            ...
            while (!context.isStopped()) {
                SomeOperation operation = new SomeOperation(syncBackupCount, asyncBackupCount, backupDelayNanos);
