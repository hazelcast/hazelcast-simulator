...
public class Hazelcast4Driver extends VendorDriver<HazelcastInstance> {
    ...
    public WorkerParameters loadWorkerParameters(String workerType, int agentIndex) {
        ...
        if ("hazelcast-enterprise4".equals(get("VENDOR"))) {
            String licenceKey = get("LICENCE_KEY");
            if (licenceKey == null) {
                throw new IllegalStateException("licenceKey needs to be set with 'hazelcast-enterprise4' as vendor");
            }
        }
