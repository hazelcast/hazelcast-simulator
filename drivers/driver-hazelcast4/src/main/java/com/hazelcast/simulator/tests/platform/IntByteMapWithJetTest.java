...
import com.hazelcast.simulator.tests.platform.nexmark.BenchmarkProperties;
import com.hazelcast.simulator.tests.platform.nexmark.Q01CurrencyConversion;
...
public class IntByteMapWithJetTest extends HazelcastTest {
    ...
    // jet job properties
    public int eventPerSecond = 100_000; // it should be higher than 8192 for Nexmark Q1
    public int numDistinctKey = 1_000;
    public int windowSize = 1_000;
    public long slideBy = 500;
    ...
    public void prepareJetJob() {
        Q01CurrencyConversion q1 = new Q01CurrencyConversion();
        ...
        job = q1.run(targetInstance, props);
    }
