...
import com.hazelcast.simulator.tests.platform.nexmark.Q02Selection;
...
public class MapTransactionWithJetTest extends HazelcastTest {
    ...
    // Jet job properties
    public int eventPerSecond = 10_000;
    ...
    public void prepareJetJob() {
        Q02Selection q2 = new Q02Selection();
        ...
        job = q2.run(targetInstance, props);
    }
