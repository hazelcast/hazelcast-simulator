 ...
 */
package com.hazelcast.simulator.hazelcast5;
...
public class Hazelcast5Driver extends Driver<HazelcastInstance> {
    ...
    private static final Logger LOGGER = Logger.getLogger(Hazelcast5Driver.class);
