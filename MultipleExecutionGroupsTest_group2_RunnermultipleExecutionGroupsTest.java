...
public class MultipleExecutionGroupsTest_group2_RunnermultipleExecutionGroupsTest extends TimeStepRunner {

    public MultipleExecutionGroupsTest_group2_RunnermultipleExecutionGroupsTest(com.hazelcast.simulator.worker.testcontainer.TestContainer_TimeStepMultipleExecutionGroupsTest.MultipleExecutionGroupsTest testInstance, TimeStepModel model, String executionGroup) {
    ...
    public void timeStepLoop() throws Exception {
        ...
        final com.hazelcast.simulator.probes.impl.HdrProbe group2TimeStepProbe = (com.hazelcast.simulator.probes.impl.HdrProbe)probeMap.get("group2TimeStep");
        ...
        while (!testContext.isStopped()) {
            ...
            testInstance.group2TimeStep( );
            group2TimeStepProbe.recordValue(System.nanoTime() - startNanos);
            iteration++;
