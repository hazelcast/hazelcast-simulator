...
public class Jedis5Driver extends Driver<JedisCluster> {
    ...
    public void startDriverInstance() throws Exception {
        ...
        String password = get("REDIS_CLUSTER_PASSWORD");
        if (password != null) {
            this.client = new JedisCluster(addresses, 30000, 30000, 3, password, poolConfig);
        } else {
