...
function postprocess_hdr(){
    ...
    echo "[INFO]     Postprocessing [$session_id] HDR-histogram starting..."
    ...
    echo "[INFO]     Postprocessing [$session_id] HDR-histogram completed"
}

function postprocess_gclog(){
    session_dir=$1

    echo "[INFO]     Postprocessing [$session_id] GC-logs starting..."
    ...
    echo "[INFO]     Postprocessing [$session_id] GC-logs completed"
}
