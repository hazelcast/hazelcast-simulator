...
public final class PayloadUtils {
    ...
    private static final boolean COMPRESS_HEX_OUTPUT = true;
    ...
    static byte[] makePayload(int payloadSize) {
        if (payloadSize <= 0) {
            return null;
        }
    ...
    static void addHeadTailMarkers(byte[] payload) {
        payload[0] = 0xA;
        payload[1] = 0xB;
        payload[2] = 0xC;
    ...
    private static void check(byte[] payload, int index, int value) {
