...
class OperationTestUtil {

    static ResponseType process(OperationProcessor processor, SimulatorOperation operation, SimulatorAddress address) {
    ...
    static ResponseType processOperation(AbstractOperationProcessor processor,
