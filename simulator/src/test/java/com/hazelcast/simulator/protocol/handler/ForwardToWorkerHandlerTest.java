...
public class ForwardToWorkerHandlerTest {
    ...
    public void before() {
        ...
        when(channel.attr(forwardAddressIndex)).thenReturn(forwardAddressIndexAttribute);
    ...
    @Test
    public void testChannelRead0_forwardResponse_WorkerNotFound() {
        ...
        verify(channel).attr(forwardAddressIndex);
