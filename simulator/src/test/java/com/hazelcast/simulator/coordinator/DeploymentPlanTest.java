...
//        DeploymentPlan plan = null;//createDeploymentPlan(componentRegistry, workerParametersMap, JAVA_CLIENT, 1, 0);
//
...
//        WorkerParameters firstWorker = new WorkerParameters(
//                1,
//                WorkerType.MEMBER,
//                "any version",
//                "any script",
...
//        );
//        WorkerParameters secondWorker = new WorkerParameters(
//                5,
//                WorkerType.MEMBER,
//                "any version",
//                "any script",
...
//                0,
//                new HashMap<String, String>());
//        WorkerParameters thirdWorker = new WorkerParameters(
//                2,
//                JAVA_CLIENT,
//                "any version",
//                "any script",
...
//        Map<SimulatorAddress, List<WorkerParameters>> workerDeployment = plan.getWorkerDeployment();
//        List<WorkerParameters> settingsList = workerDeployment.get(agentAddress);
//        WorkerParameters settings = settingsList.get(index);
